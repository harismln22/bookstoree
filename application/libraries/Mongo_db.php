...
Class Mongo_db{
	...
	*/
	public function where_gt($x, $field = "" )
	{
		if (!isset($field))
		{
	...
	*/
	public function where_gte($x, $field = "" )
	{
		if (!isset($field))
		{
	...
	*/
	public function where_lt( $x, $field = "")
	{
		if (!isset($field))
		{
	...
	*/
	public function where_lte( $x, $field = "")
	{
		if (!isset($field))
		{
	...
	*/
	public function where_between($x, $y, $field = "")
	{
		if (!isset($field))
		{
	...
	*/
	public function where_between_ne($x, $y, $field = "")
	{
		if (!isset($field))
		{
	...
	*/
	public function where_ne($x, $field = '')
	{
		if (!isset($field))
		{
